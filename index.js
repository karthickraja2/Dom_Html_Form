...
let fname_div = sixdiv("div", "form-group", "col-md-10");
let lname_div = sixdiv("div", "form-group", "col-md-10");
...
let food_label2 = fooditemslabel("label", "for", "food", "Biriyani, TamilNdau.");
...
function btnname() {
  ...
  if (null_value.length > 2) {
    alert("<<Please select 2 Food items Out of 5>>");
  }
